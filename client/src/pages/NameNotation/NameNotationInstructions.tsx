...
export interface NameNotationInstructionProps {
...
const MakeMoveInstructions = (props: NameNotationInstructionProps) => {
  const {
    setIsPlaying,
    setIsPractice,
    selectedColor,
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-3">
          <p className="text-md">
            ...
            random board position and an arrow indicating a move to be made.
            Your goal is to write out the move in algebraic notation and do that
            for as many moves as possible in 60 seconds!
          </p>
          <p className="text-sm">
